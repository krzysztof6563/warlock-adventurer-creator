...
generatorStore.adventurer = new Adventurer(
    generatorStore.skills.map((name) => ({ name: name, value: 0 }))
)

const adventurer = generatorStore.adventurer;
watch(() => adventurer.luck, (newValue, oldValue) => adventurer.courage = 20 - newValue)
</script>
